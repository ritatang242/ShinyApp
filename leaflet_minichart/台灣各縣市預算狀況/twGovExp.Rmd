...
pacman::p_load(shinyWidgets,sf,tmap,dplyr,tidyr,googleVis)
pacman::p_load(leaflet,leaflet.minicharts)

load("data/geotw108.rdata") # 鄉鎮區界 + 人口統計 # data: twTown, twCounty, twVill
...
load("data/budget.rdata") # 2011~2019全台預算資料 # data: D
...
<img src="data/BAPlogo.png" alt="CM.NSYSU" width="80" height="80" align="left"></br>
